...
app.put('/contact', [
    ...
    // Anda bisa menambahkan validasi untuk field tambahan di sini jika diperlukan.
], (req, res, next) => {
    // ... kode lainnya
    Contact.updateOne(
        { _id: req.body._id }, 
        { 
            $set: {
                ...
                umur: req.body.umur, // tambahkan field umur
                tanggal_lahir: req.body.tanggal_lahir, // tambahkan field tanggal_lahir
                nomor_telepon: req.body.nomor_telepon, // tambahkan field nomor_telepon
                alamat: req.body.alamat, // tambahkan field alamat
                foto: req.body.foto // tambahkan field foto
            }
        }
    )
    .then(result => {
